...
from .models import Subject,CustomUser, StudentResult
...
class EditResultView(View):
    def get(self, request, *args, **kwargs):
        ...
        staff = get_object_or_404(CustomUser, id=request.user.id)
        resultForm.fields['subject'].queryset = Subject.objects.filter(user_id =staff.id)
        context = {
            'form': resultForm,
